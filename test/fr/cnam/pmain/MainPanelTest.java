...
//    private static MainPanel mainPanel;
    ...
    public static Collection variable() {
        return Arrays.asList(new Object[][] {
                {
                        new ControlButtonsPanel(mainPanel), new ControlButtonsPanel(mainPanel), new CalendarPanel(),  new CalendarPanel(), new JLabel(), new JLabel(), "Le Calendrier des Lunaires\n", "Le Calendrier des Lunaires\n"
                },
//                {
